...
it('can insert event if authenticated', function () {
    ...
    $data = [
        ...
        'end_date' => '2021-02-02 00:00:00',
        'poker_tournament' => PokerTournament::factory()->create(),
        'poker_tournament_id' => PokerTournament::factory()->create()->id,
    ];
    ...
    $datas->assertSessionHasErrors('start_date');
